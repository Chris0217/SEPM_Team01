...
function MyPage() {
  ...
  useEffect(() => {
    axios.get("http://localhost:3500/api/allIngredients").then((response) => {
      setAllIngredients(
        response.data.map((ing) => ({ value: ing, label: ing }))
      );
    });
  }, []);
  ...
  const allAllergens = [
    { value: "Alcohol-Free", label: "Alcohol" },
    { value: "Celery-Free", label: "Celery" },
    { value: "Crustcean-Free", label: "Crustcean" },
    { value: "Dairy-Free", label: "Dairy" },
    { value: "Egg-Free", label: "Egg" },
    { value: "Fish-Free", label: "Fish" },
    { value: "FODMAP-Free", label: "FODMAP" },
    { value: "Gluten-Free", label: "Gluten" },
    { value: "Lupine-Free", label: "Lupine" },
    { value: "Mollusk-Free", label: "Mollusk" },
    { value: "Mustard-Free", label: "Mustard" },
    { value: "Peanut-Free", label: "Peanut" },
    { value: "Pork-Free", label: "Pork" },
    { value: "Red-Meat-Free", label: "Red-Meat" },
    { value: "Sesame-Free", label: "Sesame" },
    { value: "Shellfish-Free", label: "Shellfish" },
    { value: "Soy-Free", label: "Soy" },
    { value: "Sulfite-Free", label: "Sulfite" },
  ...
  return (
    <section class="mypage_section">
      <form onSubmit={handleSubmit}>
        ...
        <div class="buttons">
          <button type="changeMode" onClick={handleMode}>
            {editMode ? "Cancel" : "Edit"}
          </button>
          <button type="submit" disabled={editMode ? false : true}>
            Save
          </button>
        </div>
      </form>
